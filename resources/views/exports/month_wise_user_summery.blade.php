<table>
    ...
    @foreach($report as $row)
        <tr>
            ...
            <td style="text-align: left;">{{ $row['earliest_in'] }}</td>
            <td style="text-align: left;">{{ $row['latest_late_in'] }}</td>
            <td style="text-align: left;">{{ $row['earliest_out'] }}</td>
            <td style="text-align: left;">{{ $row['latest_late_out'] }}</td>
