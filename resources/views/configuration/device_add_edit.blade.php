                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="serial_no"
                                ...
                                class="form-control {{ hasError('serial_no') }}" placeholder="Serial No.">
                            @error('serial_no')
                                {!! displayError($message) !!}
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ip_address"
                                ...
                                class="form-control {{ hasError('ip_address') }}" placeholder="Device IP Address">
                            @error('ip_address')
                                {!! displayError($message) !!}
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="device_port"
                                ...
                                class="form-control {{ hasError('device_port') }}" placeholder="Device Port">
                            @error('device_port')
                                {!! displayError($message) !!}
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="comm_key" value="{{ old('comm_key') ?? ($device->comm_key ?? '') }}"
                                class="form-control {{ hasError('comm_key') }}" placeholder="Communication Key(Comm Key)">
                            @error('comm_key')
                                {!! displayError($message) !!}
                            @enderror
                        </div>
